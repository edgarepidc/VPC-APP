...
export function EditProjectForm({
  ...
  return (
    <div className="min-w-[220px] rounded border border-slate-200 bg-slate-50 p-2 text-left shadow-sm">
      <p className="text-[11px] font-medium text-slate-700">Editar proyecto</p>
      <form action={updateAction} className="mt-2 space-y-2">
        <input type="hidden" name="projectId" value={projectId} />
        <div>
          <label className="text-[10px] text-slate-600">Nombre</label>
          <input
            name="name"
            required
            maxLength={200}
        ...
        <div>
          <label className="text-[10px] text-slate-600">Descripción</label>
          <textarea
            name="description"
            rows={2}
            maxLength={2000}
        ...
        <div>
          <label className="text-[10px] text-slate-600">Estado</label>
          <select
            name="status"
